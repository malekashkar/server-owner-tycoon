...
export default class BugReportCommand extends TicketCommand {
  cmdName = "bugreport";
  description = "Close a bug report ticket channel.";
  ...
  async run(message: Message) {
    ...
    if (confirm) {
      ...
      (message.guild.channels.resolve(channels.bugreports) as TextChannel).send(
